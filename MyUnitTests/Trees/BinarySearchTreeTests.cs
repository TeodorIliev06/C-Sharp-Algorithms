namespace MyUnitTests.Trees
{
    ...
    public class BinarySearchTreeTests
    {
        ...
        [Test]
        public void Delete_LeftChildHasNoRightChild_ShouldPromoteLeftChild()
        {
            // Arrange
            BinarySearchTree<int> bst = new BinarySearchTree<int>();
            bst.Insert(20);
            ...
            // Assert
            int[] expectedNodes = new int[] { 1, 3, 7, 10, 15, 20, 25, 30 };
            CollectionAssert.AreEqual(expectedNodes, nodes);
        }

        [Test]
        public void Delete_LeftChildHasRightChild_ShouldPromoteLargestRight()
        {
            // Arrange  
            BinarySearchTree<int> bst = new BinarySearchTree<int>();
            bst.Insert(20);
            ...
            // Act
            bst.Delete(10);  // 10 has both children, left child (5) has right children

            List<int> nodes = new List<int>();
            bst.EachInOrder(nodes.Add);

            // Assert  
            int[] expectedNodes = new int[] { 1, 3, 5, 6, 7, 8, 15, 20, 25, 30 };
            CollectionAssert.AreEqual(expectedNodes, nodes);
        }
    }
}
